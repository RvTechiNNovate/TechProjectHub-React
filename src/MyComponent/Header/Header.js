...
export const Header = () => {
	...
	return (
		<>
			<nav className="menu-bg navbar navbar-expand-lg navbar-light fixed-top bg-light fixedheight text-center pt-0 pb-0" id="nav">
					...
					<div className="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<ul className="navbar-nav  menu-bg  horizontal-list nav-menu right">
							<li className="nav-item pad">
								<Link activeClass="active" className="navhover" aria-current="page" to="/">Home</Link>
							</li>
							<li className="nav-item pad">
							...
							<li className="nav-item pad">
								<Link  className="navhover" to="contact">Contact Us</Link>
							</li>
						</ul>
