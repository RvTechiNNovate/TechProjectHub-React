...
export const Header = () => {
	...
	return (
		<Router>
			<nav className="navbar  navbar-expand-lg navbar-light fixed-top bg-light fixedheight text-center">
				<div className="container-fluid ">
					...
					<div className="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<ul className="navbar-nav    horizontal-list nav-menu right">
							<li className="nav-item pad">
								<Link className="navhover" aria-current="page" to="/">Home</Link>
							</li>
							<li className="nav-item pad">
								<Link className="navhover" to="/">About</Link>
							</li>
